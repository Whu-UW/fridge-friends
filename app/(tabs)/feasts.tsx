...
export default function FeastsScreen() {
  ...
  const handleSendInvite = () => {
    ...
    const newFeast: FeastInvite = {
      ...
      candidateRecipes: [{ recipe: activeRecipe as any, votes: [] }],
    ...
    Alert.alert(
      'Invites Sent! ✉️',
      `Sent feast invites for "${activeRecipe.title}" (${scheduledDateTime})! You can track RSVPs in Meals. Friends must confirm before they're counted in.`,
      [
        {
          text: 'Track RSVPs',
